  ...
  return (
    <svg width="22" height="14" viewBox="0 0 22 14" fill="none" aria-hidden="true">
      <path d="M1 7 C3 2,5 12,7 7 C9 2,11 12,13 7 C15 2,17 12,19 7 C20 5,21 6,22 7"
        stroke="#8C5737" strokeWidth="1.3" strokeLinecap="round" fill="none" opacity="0.80" />
    </svg>
  )
}
function IconBook() {
  return (
    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" aria-hidden="true">
      <rect x="1" y="1" width="16" height="18" rx="2" stroke="#8C5737" strokeWidth="1.2" opacity="0.75" />
      <line x1="5" y1="6" x2="13" y2="6" stroke="#8C5737" strokeWidth="1" opacity="0.5" />
      <line x1="5" y1="9.5" x2="13" y2="9.5" stroke="#8C5737" strokeWidth="1" opacity="0.5" />
      <line x1="5" y1="13" x2="10" y2="13" stroke="#8C5737" strokeWidth="1" opacity="0.5" />
      <rect x="1" y="1" width="3" height="18" rx="1" fill="rgba(140,87,55,0.12)" />
    </svg>
  )
}
function IconMic() {
  return (
    <svg width="16" height="20" viewBox="0 0 16 20" fill="none" aria-hidden="true">
      <rect x="4" y="1" width="8" height="11" rx="4" stroke="#8C5737" strokeWidth="1.2" opacity="0.75" />
      <path d="M1 10 C1 15, 15 15, 15 10" stroke="#8C5737" strokeWidth="1.2" strokeLinecap="round" fill="none" opacity="0.65" />
      <line x1="8" y1="15" x2="8" y2="19" stroke="#8C5737" strokeWidth="1.2" strokeLinecap="round" opacity="0.65" />
      <line x1="5" y1="19" x2="11" y2="19" stroke="#8C5737" strokeWidth="1.2" strokeLinecap="round" opacity="0.65" />
    </svg>
  )
}
function IconScroll() {
  return (
    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" aria-hidden="true">
      <path d="M4 1 H14 C15.1 1 16 1.9 16 3 V17 C16 18.1 15.1 19 14 19 H4 C2.9 19 2 18.1 2 17 V3 C2 1.9 2.9 1 4 1 Z" stroke="#8C5737" strokeWidth="1.2" opacity="0.70" />
      <path d="M2 3 C2 1.9 2.9 1 4 1 C5.1 1 6 1.9 6 3 V17 C6 18.1 5.1 19 4 19 C2.9 19 2 18.1 2 17 Z" stroke="#8C5737" strokeWidth="1.2" fill="rgba(140,87,55,0.06)" opacity="0.70" />
      <line x1="8" y1="7" x2="14" y2="7" stroke="#8C5737" strokeWidth="1" opacity="0.50" />
      <line x1="8" y1="10" x2="14" y2="10" stroke="#8C5737" strokeWidth="1" opacity="0.50" />
      <line x1="8" y1="13" x2="12" y2="13" stroke="#8C5737" strokeWidth="1" opacity="0.50" />
    </svg>
  )
}
function IconLeaf() {
  return (
    <svg width="16" height="20" viewBox="0 0 16 20" fill="none" aria-hidden="true">
      <path d="M8 19 C8 19, 1 13, 1 7 C1 3.7 4.1 1 8 1 C11.9 1 15 3.7 15 7 C15 13 8 19 8 19 Z"
        stroke="#8C5737" strokeWidth="1.2" fill="none" opacity="0.70" />
      <line x1="8" y1="19" x2="8" y2="7" stroke="#8C5737" strokeWidth="1" strokeLinecap="round" opacity="0.50" />
      <line x1="8" y1="10" x2="12" y2="7" stroke="#8C5737" strokeWidth="0.9" strokeLinecap="round" opacity="0.40" />
      <line x1="8" y1="13" x2="4" y2="10" stroke="#8C5737" strokeWidth="0.9" strokeLinecap="round" opacity="0.40" />
    </svg>
  )
}
...
export function Block07Offer() {
  ...
  return (
    <section id="block7" style={{ background: '#1D1D1D', position: 'relative' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div aria-hidden="true" style={{
              ...
              <span style={{ flex: 1, height: '1px', background: 'rgba(140,87,55,0.20)' }} />
              <span style={{
                fontFamily: "'Cinzel', serif",
                fontSize: '0.55rem',
            ...
            >
              <button
                style={{
                  ...
                  border: 'none',
                  cursor: 'pointer',
                  boxShadow: '0 4px 28px rgba(140,87,55,0.28)',
                  transition: 'box-shadow 0.25s ease, transform 0.2s ease',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = '0 6px 36px rgba(140,87,55,0.42)'
                  e.currentTarget.style.transform = 'translateY(-1px)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = '0 4px 28px rgba(140,87,55,0.28)'
